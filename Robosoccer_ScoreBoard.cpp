...
int main()
{
    ...
    createTrackbar("red", "image", &r, 255);
    createTrackbar("green", "image", &g, 255);
    createTrackbar("blue", "image", &b, 255);
    ...
    while (1)
    {
        ...
        if (frame.data != NULL)
        {
            imshow("image", colorextract(frame, v, r, g, b));
            imshow("Win", frame);
